...
- [ ] Create a list of words that are using mixed Inflection.  (IE built and builded, cursed and cursedst).  Builded is the archiach use of the past tense of build and the modern equivelent is built.  Most of the bible uses built, so builded should be scrapped in place of the modern built.
