#!/usr/bin/env python3
"""68_merge_kj_round6.py — merge the King James agent's suggestion files into
references/rounds/round6/rare_word_round6_review.md (Rare-Word Review List Protocol,
CLAUDE.md, owner directive 2026-07-22).

Usage:
    python3 scripts/68_merge_kj_round6.py <suggestions1.md> [<suggestions2.md> ...]
...
def main():
    ...
    while i < len(lines):
        ...
        field_idx = [k for k, e in enumerate(entry)
                     if e.startswith(("- KJ proposal:", "- alternates:", "- advice:", "- note:"))]
